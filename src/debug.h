...
//namespace{msg}
//enum msg_type {debug, error, warning};
...
#define debug std::cout   << "[" << FORE_BLUE   << "INFO"  << RESET << "]  " << __PRETTY_FUNCTION__ << ": "
#define err std::cout     << "[" << FORE_RED    << "ERROR" << RESET << "] "  << __PRETTY_FUNCTION__ << ": "
#define warning std::cout << "[" << FORE_YELLOW << "WARN"  << RESET << "]  " << __PRETTY_FUNCTION__ << ": "
